    ...
    return buildCalibrationRecord({
      ...
      result: terminalResult
        ? {
            ...
            human_face_score: terminalResult.human_face_score,
            human_face_message: terminalResult.human_face_message,
            human_face_enabled: terminalResult.human_face_enabled,
